...
#if (BTC_SPP_INCLUDED == 1)
#include "btc_spp.h"
#endif /* #if (BTC_SPP_INCLUDED == 1) */
#if BTC_HF_INCLUDED
#include "btc_hf_ag.h"
...
#endif //GATTC_INCLUDED == 1 || GATTS_INCLUDED == 1
#if (BLE_INCLUDED == 1)
...
#if GATTS_INCLUDED == 1 && GATT_DYNAMIC_MEMORY == 1
...
#if BTC_HF_CLIENT_INCLUDED == 1 && HFP_DYNAMIC_MEMORY == 1
...
#if BTC_AV_INCLUDED == 1 && AVRC_DYNAMIC_MEMORY == 1
    if (btc_rc_cb_ptr) {
