...
#if (defined(BTIF_INCLUDED) && BTIF_INCLUDED == 1)
#include "common/bt_defs.h"
#if (BTM_OOB_INCLUDED == 1)
#include "btif_dm.h"
#endif
#endif /* #if (defined(BTIF_INCLUDED) && BTIF_INCLUDED == 1) */
#if (defined BLE_INCLUDED && BLE_INCLUDED == 1 && SMP_INCLUDED == 1)
...
#if (defined CLASSIC_BT_INCLUDED && CLASSIC_BT_INCLUDED == 1 && BT_SSP_INCLUDED == 1)
#include "common/bte_appl.h"
#include "btm_int.h"
...
**                  *p_oob_data - 1, if OOB data is available for the peer device.
**                  *p_auth_req - 1, if MITM protection is required.
**
** Returns          void.
**
*******************************************************************************/
...
**                  oob_data - 1, if OOB data is available for the peer device.
**                  auth_req - 1, if MITM protection is required.
**
** Returns          void.
**
*******************************************************************************/
...
**
** Parameters       bd_addr  - The peer device
**                  *p_upgrade - 1, if link key upgrade is desired.
**
** Returns          void.
**
*******************************************************************************/
...
**
** Parameters       valid - 1, if the local OOB data is retrieved from LM
...
#endif  ///defined(BTIF_INCLUDED) && BTIF_INCLUDED == 1
#if (SMP_INCLUDED == 1)
                          ...
                          tBTA_LE_KEY_TYPE  *p_resp_key )
{
    ...
    *p_oob_data = bte_appl_cfg.oob_support;
    ...
    /* *p_auth_req by default is 0 for devices with NoInputNoOutput; 1 for other devices. */
