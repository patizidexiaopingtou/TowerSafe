...
/* #define BTA_HF_CLIENT_DEBUG 1 */

#ifndef BTA_HF_CLIENT_DEBUG
#define BTA_HF_CLIENT_DEBUG 0
#endif

#if BTA_HF_CLIENT_DEBUG == 1
...
static void bta_hf_client_colli_timer_cback (TIMER_LIST_ENT *p_tle)
{
    ...
    if (p_tle) {
        bta_hf_client_cb.scb.colli_tmr_on = 0;
                                    ...
                                    UINT8 app_id, BD_ADDR peer_addr)
{
    ...
    if (bta_hf_client_cb.scb.state == BTA_HF_CLIENT_OPENING_ST) {
        ...
        bta_hf_client_cb.scb.colli_tmr_on = 1;
    }
}
...
static void send_post_slc_cmd(void)
{
    ...
    bta_hf_client_send_at_ccwa(1);
    bta_hf_client_send_at_cmee(1);
    bta_hf_client_send_at_cops(0);
    bta_hf_client_send_at_btrh(1, 0);
    bta_hf_client_send_at_clip(1);
}
...
void bta_hf_client_slc_seq(BOOLEAN error)
{
    ...
    case BTA_HF_CLIENT_AT_CIND:
        bta_hf_client_send_at_cind(1);
        break;

    case BTA_HF_CLIENT_AT_CIND_STATUS:
        bta_hf_client_send_at_cmer(1);
        break;
