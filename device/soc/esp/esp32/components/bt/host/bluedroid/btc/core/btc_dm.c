...
#if (BTC_GAP_BT_INCLUDED == 1)
#include "btc_gap_bt.h"
#endif /* BTC_GAP_BT_INCLUDED == 1 */
/******************************************************************************
**  Constants & Macros
******************************************************************************/
...
void btc_dm_load_ble_local_keys(void)
{
    ...
    if (btc_storage_get_ble_local_key(BTC_LE_LOCAL_KEY_ER,(char*)&btc_dm_cb.ble_local_key_cb.er[0],
        ...
        btc_dm_cb.ble_local_key_cb.is_er_rcvd = 1;
    ...
    if ((btc_storage_get_ble_local_key(BTC_LE_LOCAL_KEY_IR,(char*)&btc_dm_cb.ble_local_key_cb.id_keys.ir[0],
            ...
            (btc_storage_get_ble_local_key(BTC_LE_LOCAL_KEY_DHK,(char*)&btc_dm_cb.ble_local_key_cb.id_keys.dhk[0],
                                           BT_OCTET16_LEN)== BT_STATUS_SUCCESS)) {
        btc_dm_cb.ble_local_key_cb.is_id_keys_rcvd = 1;
...
static void btc_dm_auth_cmpl_evt (tBTA_DM_AUTH_CMPL *p_auth_cmpl)
{
    ...
    if ( (p_auth_cmpl->success == 1) && (p_auth_cmpl->key_present) ) {
#if 0
...
bt_status_t btc_dm_enable_service(tBTA_SERVICE_ID service_id)
{
    ...
    btc_dm_execute_service_request(1, (char *)p_id);
...
bt_status_t btc_dm_disable_service(tBTA_SERVICE_ID service_id)
{
    ...
    btc_dm_execute_service_request(0, (char *)p_id);
    ...
    case BTA_DM_DISABLE_EVT: {
        ...
        for (int i = 0; i <= BTA_MAX_SERVICE_ID; i++) {
            if (service_mask &
                ...
                btc_in_execute_service_request(i, 0);
            }
        }
    ...
    case BTA_DM_BLE_KEY_EVT: {
        ...
        switch (p_data->ble_key.key_type) {
            case BTM_LE_KEY_PENC: {
                ...
                btc_dm_cb.pairing_cb.ble.is_penc_key_rcvd = 1;
            ...
            case BTM_LE_KEY_PID: {
                ...
                btc_dm_cb.pairing_cb.ble.is_pid_key_rcvd = 1;
            ...
            case BTM_LE_KEY_PCSRK: {
                ...
                btc_dm_cb.pairing_cb.ble.is_pcsrk_key_rcvd = 1;
            ...
            case BTM_LE_KEY_LENC: {
                ...
                btc_dm_cb.pairing_cb.ble.is_lenc_key_rcvd = 1;
            ...
            case BTM_LE_KEY_LCSRK: {
                ...
                btc_dm_cb.pairing_cb.ble.is_lcsrk_key_rcvd = 1;
            ...
            case BTM_LE_KEY_LID: {
                ...
                btc_dm_cb.pairing_cb.ble.is_lidk_key_rcvd =  1;
                break;
            }
            default:
                break;
