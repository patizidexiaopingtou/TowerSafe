...
#endif
// tBTA_SYS_CB bta_sys_cb = {0};
hash_map_t *bta_alarm_hash_map;
size_t BTA_ALARM_HASH_MAP_SIZE = 17;
osi_mutex_t bta_alarm_lock;
...
tBTA_SYS_ACTION bta_sys_action[] = {
...
UINT8 bta_sys_hw_off[][BTA_SYS_NUM_COLS] = {
...
UINT8 bta_sys_hw_stopping[][BTA_SYS_NUM_COLS] = {
    /* Event                    Action 1                   Action 2               Next State */
...
typedef UINT8 (*tBTA_SYS_ST_TBL)[BTA_SYS_NUM_COLS];

/* state table */
tBTA_SYS_ST_TBL bta_sys_st_tbl[] = {
    bta_sys_hw_off,
    bta_sys_hw_starting,
    bta_sys_hw_on,
    bta_sys_hw_stopping
...
**
*******************************************************************************/
void bta_sys_register(UINT8 id, tBTA_SYS_REG *p_reg)
{
    bta_sys_cb.reg[id] = (tBTA_SYS_REG *) p_reg;
    bta_sys_cb.is_reg[id] = 1;
}
