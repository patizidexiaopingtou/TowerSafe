        ...
        if (registr.chnl == BTA_AV_CHNL_AUDIO) {
            ...
            while (index < BTA_AV_MAX_SEPS &&
                    (p_scb->p_cos->init)(&codec_type, cs.cfg.codec_info,
                                         &cs.cfg.num_protect, cs.cfg.protect_info, p_data->api_reg.tsep) == 1) {
...
**
** Returns          1, if role switch is done
**
*******************************************************************************/
