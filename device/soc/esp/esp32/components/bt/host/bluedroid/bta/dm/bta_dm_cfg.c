...
/* 1 to avoid scatternet when av is streaming (be the master) */
#ifndef BTA_DM_AVOID_SCATTER_A2DP
#define BTA_DM_AVOID_SCATTER_A2DP    1
#endif
...
**
** When BTM_EIR_DEFAULT_FEC_REQUIRED is 1,
...
**                    (same reason of DM5)
**
** When BTM_EIR_DEFAULT_FEC_REQUIRED is 0,
...
#else
    NULL
#endif /* #if (BTC_GAP_BT_INCLUDED == 1) */
};
