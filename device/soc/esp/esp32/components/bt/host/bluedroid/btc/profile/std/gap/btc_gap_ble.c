        ...
        for (int position = 0; position < p_adv_data->service_uuid_len; position += LEN_UUID_128) {
            ...
            case (LEN_UUID_16): {
                if (NULL == bta_adv_data->p_services) {
                    ...
                    bta_adv_data->p_services->list_cmpl = 0;
            ...
            case (LEN_UUID_32): {
                if (NULL == bta_adv_data->p_service_32b) {
                    ...
                    bta_adv_data->p_service_32b->list_cmpl = 0;
            ...
            case (LEN_UUID_128): {
                ...
                if (NULL == bta_adv_data->p_services_128b) {
                    ...
                    if (NULL != bta_adv_data->p_services_128b) {
                        ...
                        bta_adv_data->p_services_128b->list_cmpl = 1;
                    }
                }
                break;
            }
...
void btc_gap_ble_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_GAP_BLE_CFG_EXT_ADV_DATA_RAW:
        ...
        BTA_DmBleGapConfigExtAdvDataRaw(0, arg_5->ext_adv_cfg_data.instance,
    ...
    case BTC_GAP_BLE_CFG_EXT_SCAN_RSP_DATA_RAW:
        ...
        BTA_DmBleGapConfigExtAdvDataRaw(1, arg_5->ext_adv_cfg_data.instance,
                                       arg_5->ext_adv_cfg_data.length,
                                       (const UINT8 *)arg_5->ext_adv_cfg_data.data);
        break;
    case BTC_GAP_BLE_EXT_ADV_START: {
        ...
        BTA_DmBleGapExtAdvEnable(1, arg_5->ext_adv_start.num_adv,
    ...
    case BTC_GAP_BLE_EXT_ADV_STOP: {
        ...
        if(num_adv > 0) {
            ...
            if(ext_adv) {
                ...
                BTA_DmBleGapExtAdvEnable(0, num_adv, ext_adv);
                osi_free(ext_adv);
            } else {
                BTC_TRACE_ERROR("%s no mem\n", __func__);
            }
        } else {
            BTA_DmBleGapExtAdvEnable(0, 0, NULL);
        }
	break;
    }
    ...
    case BTC_GAP_BLE_PERIODIC_ADV_START:
        ...
        BTA_DmBleGapPeriodicAdvEnable(1, arg_5->periodic_adv_start.instance);
        break;
    case BTC_GAP_BLE_PERIODIC_ADV_STOP:
        BTC_TRACE_DEBUG("BTC_GAP_BLE_PERIODIC_ADV_STOP");
        BTA_DmBleGapPeriodicAdvEnable(0, arg_5->periodic_adv_stop.instance);
        break;
    ...
    case BTC_GAP_BLE_START_EXT_SCAN:
        ...
        BTA_DmBleGapExtScan(1, arg_5->start_ext_scan.duration, arg_5->start_ext_scan.period);
        break;
    case BTC_GAP_BLE_STOP_EXT_SCAN:
        BTC_TRACE_DEBUG("BTC_GAP_BLE_STOP_EXT_SCAN");
        BTA_DmBleGapExtScan(0, 0, 0);
        break;
