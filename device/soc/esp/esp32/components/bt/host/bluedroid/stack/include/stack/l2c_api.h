...
**              Local CID
**              1 if congested, 0 if uncongested
*/
...
// must not be NULL. This function returns 1 if the callbacks could be updated,
...
**      channel
**      BD Address of remote
**      1 if channel is connected, 0 if disconnected
...
**
**  Return value:   1 if registered OK
**
*******************************************************************************/
