...
**
**
** Returns          1 if another scb is in open state, 0 otherwise.
**
*******************************************************************************/
...
**
**
** Returns          1 if scb is in open state, 0 otherwise.
**
*******************************************************************************/
