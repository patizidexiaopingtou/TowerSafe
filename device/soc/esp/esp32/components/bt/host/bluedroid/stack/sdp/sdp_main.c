...
void sdp_init (void)
{
    ...
    sdp_cb.l2cap_my_cfg.mtu_present       = 1;
    sdp_cb.l2cap_my_cfg.mtu               = SDP_MTU_SIZE;
    sdp_cb.l2cap_my_cfg.flush_to_present  = 1;
    ...
    if (!BTM_SetSecurityLevel (0, SDP_SERVICE_NAME, BTM_SEC_SERVICE_SDP_SERVER,
...
#if SDP_CLIENT_ENABLED == 1
    /* Register with Security Manager for the specific security level */
    if (!BTM_SetSecurityLevel (1, SDP_SERVICE_NAME, BTM_SEC_SERVICE_SDP_SERVER,
                               SDP_SECURITY_LEVEL, SDP_PSM, 0, 0)) {
...
#if (defined(SDP_DEBUG) && SDP_DEBUG == 1)
/*******************************************************************************
**
...
{
#if (defined(SDP_BROWSE_PLUS) && SDP_BROWSE_PLUS == 1)
