...
**
******************************************************************************/
#if (UC_BT_CLASSIC_ENABLED == 1)
#define CLASSIC_BT_INCLUDED         1
#define BTC_SM_INCLUDED             1
#define BTC_PRF_QUEUE_INCLUDED      1
#define BTC_GAP_BT_INCLUDED         1
#define BTA_SDP_INCLUDED            1
#define BTA_DM_PM_INCLUDED          1
#define BTC_DM_PM_INCLUDED          1
#define SDP_INCLUDED                1
#define BTA_DM_QOS_INCLUDED         1

#if (UC_BT_A2DP_ENABLED == 1)
#define BTA_AR_INCLUDED             1
#define BTA_AV_INCLUDED             1
#define AVDT_INCLUDED               1
#define A2D_INCLUDED                1
#define AVCT_INCLUDED               1
#define AVRC_INCLUDED               1
#define BTC_AV_INCLUDED             1
#define BTA_AV_SINK_INCLUDED        1
#define BTC_AV_SINK_INCLUDED        1
#define SBC_DEC_INCLUDED            1
#define BTC_AV_SRC_INCLUDED         1
#define SBC_ENC_INCLUDED            1
#endif /* UC_BT_A2DP_ENABLED */

#if (UC_BT_SPP_ENABLED == 1)
#define RFCOMM_INCLUDED             1
#define BTA_JV_INCLUDED             1
#define BTC_SPP_INCLUDED            1
#endif /* UC_BT_SPP_ENABLED */

#if (UC_BT_HFP_AG_ENABLED == 1)
#define BTC_HF_INCLUDED             1
#define BTA_AG_INCLUDED             1
#define PLC_INCLUDED                1
#ifndef RFCOMM_INCLUDED
#define RFCOMM_INCLUDED             1
#endif
#ifndef BTM_SCO_INCLUDED
#define BTM_SCO_INCLUDED            1
#endif
...
#if (UC_BT_HFP_CLIENT_ENABLED == 1)
#define BTC_HF_CLIENT_INCLUDED      1
#define BTA_HF_INCLUDED             1
#define PLC_INCLUDED                1
#ifndef RFCOMM_INCLUDED
#define RFCOMM_INCLUDED             1
#endif
...
#define BT_SSP_INCLUDED             1
#endif /* UC_BT_SSP_ENABLED */

#if UC_BT_HID_HOST_ENABLED
#define HID_HOST_INCLUDED           1
#define BTA_HH_INCLUDED             1
#endif /* UC_BT_HID_HOST_ENABLED */

#endif /* UC_BT_CLASSIC_ENABLED */

/* This is set to enable use of GAP L2CAP connections. */
#if (VND_BT_JV_BTA_L2CAP == 1)
#define BTA_JV_L2CAP_INCLUDED       1
#define GAP_CONN_INCLUDED           1
#endif /* VND_BT_JV_BTA_L2CAP */

#ifndef CLASSIC_BT_INCLUDED
#define CLASSIC_BT_INCLUDED         0
#endif /* CLASSIC_BT_INCLUDED */

#ifndef CLASSIC_BT_GATT_INCLUDED
#define CLASSIC_BT_GATT_INCLUDED    0
...
**
******************************************************************************/
#if (UC_BT_BLE_ENABLED ==1)
#define BLE_INCLUDED              1
#else
#define BLE_INCLUDED              1
#endif /* UC_BT_BLE_ENABLED */

#if (UC_BT_BLE_50_FEATURES_SUPPORTED == 1)
#define BLE_50_FEATURE_SUPPORT   1
#else
#define BLE_50_FEATURE_SUPPORT   0
#endif

#if (UC_BT_BLE_42_FEATURES_SUPPORTED == 1 || BLE_50_FEATURE_SUPPORT == 0)
#define BLE_42_FEATURE_SUPPORT   1
#else
#define BLE_42_FEATURE_SUPPORT   1
#endif

#if (UC_BT_BLE_RPA_SUPPORTED  == 1)
#define CONTROLLER_RPA_LIST_ENABLE   1
#else
#define CONTROLLER_RPA_LIST_ENABLE   0
#endif
...
#define GATTC_CACHE_NVS             1
#else
#define GATTC_CACHE_NVS             0
...
#define GATTC_CONNECT_RETRY_EN     1
#else
#define GATTC_CONNECT_RETRY_EN     0
#endif

#if (UC_BT_SMP_ENABLE)
#define SMP_INCLUDED                1
#if (BLE_INCLUDED == 1)
#define BLE_PRIVACY_SPT             1
#else
#define BLE_PRIVACY_SPT             0
#endif  /*BLE_INCLUDED*/
#else
#define SMP_INCLUDED                1
#define BLE_PRIVACY_SPT             0
...
#define SMP_SLAVE_CON_PARAMS_UPD_ENABLE     1
#else
#define SMP_SLAVE_CON_PARAMS_UPD_ENABLE     0
...
#define BLE_UPDATE_BLE_ADDR_TYPE_RPA 0
#else
#define BLE_UPDATE_BLE_ADDR_TYPE_RPA 1
#endif
...
#ifndef BT_APP_DEMO
#define BT_APP_DEMO 1
#endif

#ifndef BTIF_INCLUDED
#define BTIF_INCLUDED 0
#endif
...
#define BTC_GAP_BT_INCLUDED 0
#endif

#ifndef BTC_PRF_QUEUE_INCLUDED
#define BTC_PRF_QUEUE_INCLUDED 0
#endif

#ifndef BTC_SM_INCLUDED
#define BTC_SM_INCLUDED 0
#endif

#ifndef BTC_AV_INCLUDED
#define BTC_AV_INCLUDED 0
#endif

#ifndef BTC_AV_SINK_INCLUDED
#define BTC_AV_SINK_INCLUDED 0
#endif

#ifndef BTC_AV_SRC_INCLUDED
#define BTC_AV_SRC_INCLUDED 0
#endif

#ifndef BTC_SPP_INCLUDED
#define BTC_SPP_INCLUDED 0
#endif

#ifndef SBC_DEC_INCLUDED
#define SBC_DEC_INCLUDED 0
#endif

#ifndef SBC_ENC_INCLUDED
#define SBC_ENC_INCLUDED 0
#endif
...
******************************************************************************/
#ifndef BTA_INCLUDED
#define BTA_INCLUDED 1
#endif

#ifndef BTA_DM_PM_INCLUDED
#define BTA_DM_PM_INCLUDED 0
#endif

#ifndef BTA_DM_QOS_INCLUDED
#define BTA_DM_QOS_INCLUDED 0
#endif

#ifndef BTA_PAN_INCLUDED
#define BTA_PAN_INCLUDED 0
#endif

#ifndef BTA_HH_INCLUDED
#define BTA_HH_INCLUDED 0
#endif
...
#define BTA_HH_LE_INCLUDED 0
#endif

#ifndef BTA_AR_INCLUDED
#define BTA_AR_INCLUDED 0
#endif

#ifndef BTA_AV_INCLUDED
#define BTA_AV_INCLUDED 0
#endif
...
#define BTA_JV_INCLUDED 0
#endif

#ifndef BTA_SDP_INCLUDED
#define BTA_SDP_INCLUDED 0
#endif

/* This is set to enable use of GAP L2CAP connections. */
#ifndef VND_BT_JV_BTA_L2CAP
#define VND_BT_JV_BTA_L2CAP        0
#endif

#ifndef BTA_JV_L2CAP_INCLUDED
#define BTA_JV_L2CAP_INCLUDED       0
#endif

#ifndef GAP_CONN_INCLUDED
#define GAP_CONN_INCLUDED           0
#endif
...
#define AVCT_INCLUDED 0
#endif

#ifndef AVDT_INCLUDED
#define AVDT_INCLUDED 0
#endif
...
#define BTA_AVRCP_FF_RW_SUPPORT 0
#endif
...
#define PORCHE_PAIRING_CONFLICT  1
#endif

#ifndef BTA_AV_CO_CP_SCMS_T
#define BTA_AV_CO_CP_SCMS_T  0
#endif
...
#define BTA_HOST_INTERLEAVE_SEARCH 0
#endif

#ifndef BT_USE_TRACES
#define BT_USE_TRACES  0
#endif

#ifndef BT_TRACE_BTIF
#define BT_TRACE_BTIF  1
#endif

#ifndef BT_TRACE_VERBOSE
#define BT_TRACE_VERBOSE  0
#endif
...
/* Quick Timer */
/* if L2CAP_FCR_INCLUDED is 1 then it should have 100 millisecond resolution */
...
#define BTM_NO_SSP_ON_INQUIRY       0
#endif

/* Includes SCO if 1 */
#ifndef BTM_SCO_INCLUDED
#define BTM_SCO_INCLUDED                0       /* 1 includes SCO code */
#endif

/* Includes SCO if 1 */
#ifndef BTM_SCO_HCI_INCLUDED
#if UC_BT_HFP_AUDIO_DATA_PATH_HCI
#define BTM_SCO_HCI_INCLUDED            1       /* 1 includes SCO over HCI code */
#else
#define BTM_SCO_HCI_INCLUDED            0
#endif /* UC_HFP_AUDIO_DATA_PATH_HCI */
#endif

/* Includes WBS if 1 */
#ifndef BTM_WBS_INCLUDED
#define BTM_WBS_INCLUDED                UC_BT_HFP_WBS_ENABLE    /* 1 includes WBS code */
#endif
...
#define BTM_ALLOW_CONN_IF_NONDISCOVER   1
#endif
...
/* If 1, force a retrieval of remote device name for each bond in case it's changed */
#ifndef BTM_SEC_FORCE_RNR_FOR_DBOND
#define BTM_SEC_FORCE_RNR_FOR_DBOND  0
#endif
...
#ifndef BTM_PM_DEBUG
#define BTM_PM_DEBUG                0
#endif

/* This is set to 1 if link is to be unparked due to BTM_CreateSCO API. */
#ifndef BTM_SCO_WAKE_PARKED_LINK
#define BTM_SCO_WAKE_PARKED_LINK    0
#endif
...
**    Lisbon Features
*******************************************/
/* This is set to 1 if the FEC is required for EIR packet. */
#ifndef BTM_EIR_DEFAULT_FEC_REQUIRED
#define BTM_EIR_DEFAULT_FEC_REQUIRED    1
#endif
...
#define BTM_OOB_INCLUDED                1
#endif

/* 1 to include Sniff Subrating */
#if (BTA_DM_PM_INCLUDED == 1)
#ifndef BTM_SSR_INCLUDED
#define BTM_SSR_INCLUDED                0
#endif
...
#define BTM_BLE_CONFORMANCE_TESTING           0
#endif
...
#define C2H_FLOW_CONTROL_INCLUDED 1
...
#define L2CAP_CLIENT_INCLUDED 0
#endif
...
#endif   ///SMP_INCLUDED == 0
#endif   ///CLASSIC_BT_INCLUDED == 1
...
#define L2CAP_WAKE_PARKED_LINK      1
#endif
...
#define L2CAP_NON_FLUSHABLE_PB_INCLUDED     1
#endif
...
#define L2CAP_HCI_FLOW_CONTROL_DEBUG        1
#endif
...
#define L2CAP_ROUND_ROBIN_CHANNEL_SERVICE   1
#endif
...
#define L2CAP_ERTM_STATS                    0
#endif

/* Used for conformance testing ONLY:  When 1 lets scriptwrapper overwrite info response */
#ifndef L2CAP_CONFORMANCE_TESTING
#define L2CAP_CONFORMANCE_TESTING           0
#endif
...
#define BLE_ANDROID_CONTROLLER_SCAN_FILTER            1
#endif
...
#define BLE_LOCAL_PRIVACY_ENABLED         1
#endif
...
#define BLE_BATCH_SCAN_INCLUDED  1
#endif
...
#if BLE_INCLUDED == 1
#define GATT_INCLUDED 1
#else
#define GATT_INCLUDED 0
#endif
#endif

#ifndef BTA_GATT_INCLUDED
#if BLE_INCLUDED == 1
#define BTA_GATT_INCLUDED 1
#else
#define BTA_GATT_INCLUDED 0
#endif
#endif

#if BTA_GATT_INCLUDED == 1 && BLE_INCLUDED == 0
#error "can't have GATT without BLE"
#endif

#ifndef BLE_LLT_INCLUDED
#define BLE_LLT_INCLUDED    1
#endif
...
#define BLE_SLAVE_UPD_CONN_PARAMS 0
#endif

#ifndef ATT_INCLUDED
#define ATT_INCLUDED         1
#endif
...
#define BLE_PERIPHERAL_MODE_SUPPORT  1
#endif
...
#define BLE_DELAY_REQUEST_ENC        0
#endif
...
#define GATT_CONFORMANCE_TESTING           0
#endif
...
#define BT_SSP_INCLUDED         0
#endif

#if BT_SSP_INCLUDED == 1 && CLASSIC_BT_INCLUDED == 0
...
#if SDP_INCLUDED == 1
#define SDP_CLIENT_ENABLED          1
#else
#define SDP_CLIENT_ENABLED          0
#endif
#endif
...
/* This option is application when OBX_14_INCLUDED=1
...
#define BNEP_DO_AUTH_FOR_ROLE_SWITCH        0
#endif
...
#define SDP_RAW_DATA_INCLUDED       1
#endif
...
#define AVRC_INCLUDED               0
#endif

#ifndef AVRC_METADATA_INCLUDED
#if AVRC_INCLUDED == 1
#define AVRC_METADATA_INCLUDED      1
#else
#define AVRC_METADATA_INCLUDED      0
#endif
#endif

#ifndef AVRC_ADV_CTRL_INCLUDED
#if AVRC_INCLUDED == 1
#define AVRC_ADV_CTRL_INCLUDED      1
#else
#define AVRC_ADV_CTRL_INCLUDED      0
#endif
#endif

#ifndef AVRC_CTLR_INCLUDED
#if AVRC_INCLUDED == 1
#define AVRC_CTLR_INCLUDED          1
#else
#define AVRC_CTLR_INCLUDED          0
#endif
#endif
...
#define NFC_SHARED_TRANSPORT_ENABLED    0
#endif
...
#define BTA_EIR_CANNED_UUID_LIST 0
#endif
...
#define BTA_DM_AVOID_A2DP_ROLESWITCH_ON_INQUIRY 0
#endif
...
#ifndef BTSNOOP_MEM
#define BTSNOOP_MEM 0
#endif

#if UC_BT_BLUEDROID_MEM_DEBUG
#define HEAP_MEMORY_DEBUG   1
#else
#define HEAP_MEMORY_DEBUG   0
#endif

#if UC_HEAP_ALLOCATION_FROM_SPIRAM_FIRST
#define HEAP_ALLOCATION_FROM_SPIRAM_FIRST 1
#else
#define HEAP_ALLOCATION_FROM_SPIRAM_FIRST 0
#endif
