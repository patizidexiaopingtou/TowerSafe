...
static void process_l2cap_cmd (tL2C_LCB *p_lcb, UINT8 *p, UINT16 pkt_len)
{
    ...
    tL2C_CCB        *p_ccb;
    tL2C_RCB        *p_rcb;
    BOOLEAN         cfg_rej, pkt_size_rej = 0;
    ...
    while (1) {
        ...
        case L2CAP_CMD_CONFIG_REQ:
            ...
            cfg_info.flush_to_present = cfg_info.mtu_present = cfg_info.qos_present =
                                            cfg_info.fcr_present = cfg_info.fcs_present = 0;
            ...
            while (p < p_cfg_end) {
                ...
                case L2CAP_CFG_TYPE_MTU:
                    cfg_info.mtu_present = 1;
                    STREAM_TO_UINT16 (cfg_info.mtu, p);
                    break;

                case L2CAP_CFG_TYPE_FLUSH_TOUT:
                    cfg_info.flush_to_present = 1;
                    STREAM_TO_UINT16 (cfg_info.flush_to, p);
                    break;

                case L2CAP_CFG_TYPE_QOS:
                    cfg_info.qos_present = 1;
                ...
                case L2CAP_CFG_TYPE_FCS:
                    cfg_info.fcs_present = 1;
                    STREAM_TO_UINT8 (cfg_info.fcs, p);
                    break;

                case L2CAP_CFG_TYPE_EXT_FLOW:
                    cfg_info.ext_flow_spec_present = 1;
