...
**
**
** Returns          1 if stream state machine is in reconfig state.
**
*******************************************************************************/
BOOLEAN bta_av_is_rcfg_sst (tBTA_AV_SCB *p_scb)
{
    BOOLEAN is_rcfg_sst = 0;
...
**
** Description      Returns 1 is scb is in opening state.
**
**
** Returns          1 if scb is in opening state.
**
*******************************************************************************/
BOOLEAN bta_av_is_scb_opening (tBTA_AV_SCB *p_scb)
{
    BOOLEAN is_opening = 0;
...
**
** Description      Returns 1 is scb is in incoming state.
**
**
** Returns          1 if scb is in incoming state.
**
*******************************************************************************/
BOOLEAN bta_av_is_scb_incoming (tBTA_AV_SCB *p_scb)
{
    BOOLEAN is_incoming = 0;
...
**
** Description      Returns 1 is scb is in init state.
**
**
** Returns          1 if scb is in incoming state.
**
