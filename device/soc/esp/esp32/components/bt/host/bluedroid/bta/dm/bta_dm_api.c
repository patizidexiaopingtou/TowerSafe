...
tBTA_STATUS BTA_EnableBluetooth(tBTA_DM_SEC_CBACK *p_cback)
{
    ...
    // bta_dm_cb = (tBTA_DM_CB *)malloc(sizeof(tBTA_DM_CB));
...
#if (BLE_INCLUDED == 1 && BLE_ANDROID_CONTROLLER_SCAN_FILTER == 1)
    btm_ble_adv_filter_cleanup();       // when BLE_VND_INCLUDED is 0, this function will be ignore, so move it out of "if"
