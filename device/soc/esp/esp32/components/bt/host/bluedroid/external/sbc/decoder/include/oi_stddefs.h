...
#ifndef FALSE
#define FALSE 0         /**< This define statement sets 0 as a preprocessor alias for 0. */
#endif

#ifndef TRUE
#define TRUE (!FALSE)  /**< This define statement sets 1 as a preprocessor alias for !0. */
#endif
...
/** This macro's value is 1 if the bit specified by y is set in data item x. */
#define OI_BIT_TEST(x,y)   ((x) & (y))

/** This macro's value is 1 if the bit specified by y is not set in data item x. */
