...
typedef struct {
    ...
    BOOLEAN             sco_close_rfc;   /* 1 if also close RFCOMM after SCO */
    BOOLEAN             retry_with_sco_only;
    BOOLEAN             deregister;     /* 1 if service shutting down */
    BOOLEAN             svc_conn;       /* set to 1 when service level connection is up */
    BOOLEAN             send_at_reply;  /* set to 1 to notify framework about AT results */
