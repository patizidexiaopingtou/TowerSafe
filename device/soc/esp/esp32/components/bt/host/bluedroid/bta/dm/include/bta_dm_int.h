...
#if (BTA_DM_QOS_INCLUDED == 1)
    /* Quality of Service set events */
    BTA_DM_API_QOS_SET_EVT,
#endif /* #if (BTA_DM_QOS_INCLUDED == 1) */
#if (SMP_INCLUDED == 1)
...
typedef struct {
    ...
    BOOLEAN        avoid_scatter;      /* 1 to avoid scatternet when av is streaming (be the master) */
...
#if ((defined BTA_GATT_INCLUDED) &&  (BTA_GATT_INCLUDED == 1) && SDP_INCLUDED == 1) && (GATTC_INCLUDED == 1)
extern void bta_dm_close_gatt_conn(tBTA_DM_MSG *p_data);
#endif /* ((defined BTA_GATT_INCLUDED) &&  (BTA_GATT_INCLUDED == 1) && SDP_INCLUDED == 1) && (GATTC_INCLUDED == 1) */
