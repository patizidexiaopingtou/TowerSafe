...
#define BTA_AG_MULTI_RESULT_INCLUDED      0
#endif

/* Replace : in VGS and VGM for HSP */
#ifndef BTA_HSP_RESULT_REPLACE_COLON
#define BTA_HSP_RESULT_REPLACE_COLON      1
#endif
...
typedef struct
{
    ...
    BOOLEAN             codec_updated;  /* set to 1 whenever the app updates codec type */
    ...
    BOOLEAN             dealloc;        /* 1 if service shutting down */
    BOOLEAN             clip_enabled;   /* set to 1 if HF enables CLIP reporting */
    BOOLEAN             ccwa_enabled;   /* set to 1 if HF enables CCWA reporting */
    BOOLEAN             cmer_enabled;   /* set to 1 if HF enables CMER reporting */
    BOOLEAN             cmee_enabled;   /* set to 1 if HF enables CME ERROR reporting */
    BOOLEAN             inband_enabled; /* set to 1 if inband ring enabled */
    BOOLEAN             svc_conn;       /* set to 1 when service level connection up */
    TIMER_LIST_ENT      colli_timer;    /* Collision timer */
    BOOLEAN             colli_tmr_on;   /* 1 if collision timer is active */
