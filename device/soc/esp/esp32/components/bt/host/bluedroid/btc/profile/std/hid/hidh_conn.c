...
tHID_STATUS hidh_conn_reg (void)
{
    ...
    hh_cb.l2cap_cfg.mtu_present          = 1;
    hh_cb.l2cap_cfg.mtu                  = HID_HOST_MTU;
    hh_cb.l2cap_cfg.flush_to_present     = 1;
...
**
** Returns          1 if disconnect started, 0 if already disconnected
**
*******************************************************************************/
...
#if defined(HID_HOST_ACPT_NEW_CONN) && (HID_HOST_ACPT_NEW_CONN == 1)
