...
#if (HID_HOST_INCLUDED == 1)

#if HID_DYNAMIC_MEMORY == 0
tHID_HOST_CTB   hh_cb;
#endif
...
**
** Returns          1 if device is HID Device else 0
**
*******************************************************************************/
