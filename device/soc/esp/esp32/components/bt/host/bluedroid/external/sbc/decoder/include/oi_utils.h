 ...
 *
 * @return 1 if an address was successfully parsed, 0 otherwise
 */
 ...
 *
 * \%B   prints an integer as boolean text, "1" or "0".
 ...
 * SAME_BD_ADDR - Boolean: 1 if they are the same address
 */
