...
void btc_gattc_cb_handler(btc_msg_t *msg)
{
    ...
    case BTA_GATTC_CONGEST_EVT: {
        ...
        param.congest.congested = (congest->congested == 1) ? true : false;
...
void btc_gattc_congest_callback(tBTA_GATTC *param)
{
    ...
    esp_param.congest.congested = (param->congest.congested == 1) ? true : false;
