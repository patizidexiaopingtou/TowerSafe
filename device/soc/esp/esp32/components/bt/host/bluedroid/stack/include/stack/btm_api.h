...
/* MACRO to check the security service bit mask in a bit stream (Returns 1 or 0) */
#define BTM_SEC_IS_SERVICE_TRUSTED(p, service)    (((((UINT32 *)(p))[(((UINT32)(service)) / BTM_SEC_ARRAY_BITS)]) &   \
                                        (UINT32)(((UINT32)1 << (((UINT32)(service)) % BTM_SEC_ARRAY_BITS)))) ? 1 : 0)
...
typedef struct {
    ...
    BOOLEAN         is_orig;        /* 1, if local device initiated the SP process */
} tBTM_SP_IO_REQ;
...
typedef struct {
    ...
    BOOLEAN         just_works;     /* 1, if "Just Works" association model */
...
typedef struct {
    BD_ADDR         bd_addr;        /* peer address */
    BOOLEAN         upgrade;        /* 1, to upgrade the link key */
} tBTM_SP_UPGRADE;
...
**
** Returns          1 if device is up, else 0
**
*******************************************************************************/
//extern
...
**                  specific HCI events.
**
**                  If is_register=1, then the function will be registered;
**                  if is_register=0, then the function will be deregistered.
**
...
**
** Returns          Returns 1 if server channel was available
**
*******************************************************************************/
//extern
...
**
** Returns          1 if successful, 0 if SCN is not in use or invalid
**
*******************************************************************************/
//extern
...
**
** Returns          1 if connection is up, else 0.
**
*******************************************************************************/
//extern
...
**                  "is_orig" flag is 1, the connection will be originated,
...
**
** Parameter        secure_connections_only_mode - (1 or 0)
...
**
** Returns          1 if rmoved OK, 0 if not found
**
*******************************************************************************/
//extern
