...
**
** Returns          1 if encrypted, otherwise 0.
**
*******************************************************************************/
#if (SMP_INCLUDED == 1)
...
**
** Returns          BOOLEAN 1 - conversation is successful
**
*******************************************************************************/
...
BOOLEAN gatt_security_check_start(tGATT_CLCB *p_clcb)
{
    ...
    case GATT_SEC_ENC_PENDING:
        ...
        break;
    default:
        gatt_sec_check_complete(1, p_clcb, gatt_sec_act);
        break;
    }
