...
typedef struct
{
    ...
    bool                  success;               /*!< 1 of authentication succeeded, 0 if failed. */
    uint8_t               fail_reason;           /*!< The HCI reason/error code for when success=0 */
...
*
* @param[in]        add_remove: the value is 1 if added the ble device to the white list, and false remove to the white list.
