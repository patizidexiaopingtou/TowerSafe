    ...
    switch (event) {
        ...
        case BTA_AG_AT_BAC_EVT:
        {
            ...
            ** of SCO connection establishment */
            if ((btc_conf_hf_force_wbs == 1) && (p_data->val.num & BTA_AG_CODEC_MSBC)) {
