...
/*#include <math.h>*/
#if (defined(SBC_ENC_INCLUDED) && SBC_ENC_INCLUDED == 1)

#if (SBC_IS_64_MULT_IN_WINDOW_ACCU == 1)
...
#endif //BT_BLE_DYNAMIC_ENV_MEMORY == 0
...
#else /* SBC_IS_64_MULT_IN_WINDOW_ACCU == 0 */
#define WINDOW_ACCU_8_0 \
{\
...
#endif /* #if (defined(SBC_ENC_INCLUDED) && SBC_ENC_INCLUDED == 1) */
