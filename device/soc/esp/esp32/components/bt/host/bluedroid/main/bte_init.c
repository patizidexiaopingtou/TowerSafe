...
#ifndef BTA_INCLUDED
#define BTA_INCLUDED 0
#endif

#if (defined(RFCOMM_INCLUDED) && RFCOMM_INCLUDED == 1)
// Include initialization functions definitions
#include "stack/port_api.h"
#endif

#if (defined(BNEP_INCLUDED) && BNEP_INCLUDED == 1)
#include "bnep_api.h"
#endif

#if (defined(GAP_INCLUDED) && GAP_INCLUDED == 1)
#include "stack/gap_api.h"
#endif

#if (defined(PAN_INCLUDED) && PAN_INCLUDED == 1)
#include "pan_api.h"
#endif

#if (defined(AVRC_INCLUDED) && AVRC_INCLUDED == 1)
#include "stack/avrc_api.h"
#endif

#if (defined(A2D_INCLUDED) && A2D_INCLUDED == 1)
#include "stack/a2d_api.h"
#endif

#if (defined(AVDT_INCLUDED) && AVDT_INCLUDED == 1)
#include "avdt_int.h"
#endif

#if (defined(AVCT_INCLUDED) && AVCT_INCLUDED == 1)
#include "avct_int.h"
#endif

#if (defined(HID_HOST_INCLUDED) && HID_HOST_INCLUDED == 1)
#include "stack/hidh_api.h"
#endif

#if (defined(MCA_INCLUDED) && MCA_INCLUDED == 1)
#include "mca_api.h"
#endif
...
//BTA Modules
#if BTA_INCLUDED == 1 && BTA_DYNAMIC_MEMORY == 1
#include "bta/bta_api.h"
#include "bta/bta_sys.h"
#include "osi/allocator.h"

#if BTA_HF_INCLUDED == 1
...
#if BTA_SDP_INCLUDED == 1
#include "bta_sdp_int.h"
#endif

#if BTA_HS_INCLUDED == 1
#include "bta_hs_int.h"
#endif

#include "bta_dm_int.h"

#if BTA_AR_INCLUDED==1
#include "bta_ar_int.h"
#endif
#if BTA_AV_INCLUDED==1
#include "bta_av_int.h"
#endif

#if BTA_HH_INCLUDED==1
#include "bta_hh_int.h"
#endif

#if BTA_JV_INCLUDED==1
#include "bta_jv_int.h"
#endif

#if BTA_HL_INCLUDED == 1
#include "bta_hl_int.h"
#endif

#if BTA_GATT_INCLUDED == 1
#include "bta_gattc_int.h"
#include "bta_gatts_int.h"
#endif

#if BTA_PAN_INCLUDED==1
...
#endif // BTA_INCLUDED == 1 && BTA_DYNAMIC_MEMORY == 1
...
#endif //JV
#if (defined BTA_HF_INCLUDED && BTA_HF_INCLUDED == 1)
    if (bta_hf_client_cb_ptr){
        osi_free(bta_hf_client_cb_ptr);
        bta_hf_client_cb_ptr = NULL;
    }
#endif
#if (defined BTA_AG_INCLUDED && BTA_AG_INCLUDED == 1)
    if (bta_ag_cb_ptr){
...
#endif // BTA_INCLUDED == 1

#if (defined(GAP_INCLUDED) && GAP_INCLUDED == 1)
    GAP_Deinit();
#endif

#if (defined(AVCT_INCLUDED) && AVCT_INCLUDED == 1 && AVCT_DYNAMIC_MEMORY == 1)
    if (avct_cb_ptr){
...
#if (defined(AVDT_INCLUDED) && AVDT_INCLUDED == 1 && AVDT_DYNAMIC_MEMORY == 1)
    if (avdt_cb_ptr){
