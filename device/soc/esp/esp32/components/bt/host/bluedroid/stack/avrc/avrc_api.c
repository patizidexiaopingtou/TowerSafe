                               ...
                               tAVRC_MSG_VENDOR *p_msg)
{
    ...
    if (p_msg->company_id == AVRC_CO_METADATA) {
        ...
        } else if (cr == AVCT_RSP && req_continue == 1) {
...
#endif /* (AVRC_METADATA_INCLUDED == 1) */
...
#endif /* #if (defined(AVRC_INCLUDED) && AVRC_INCLUDED == 1) */
