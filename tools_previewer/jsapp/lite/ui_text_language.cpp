...
static const UITextLanguageFontParam g_uiTextLangFontsTable[LANGUAGE_FONT_ID_MAX] = {
    ...
    {14, 4, 1, 6, "NotoSansHebrew-Regular"},
    {18, 4, 1, 6, "NotoSansHebrew-Regular"},
    {24, 4, 1, 6, "NotoSansHebrew-Regular"},
    {30, 4, 1, 6, "NotoSansHebrew-Regular"},
    {38, 4, 1, 6, "NotoSansHebrew-Regular"},
    {20, 4, 1, 6, "NotoSansHebrew-Regular"},
    {23, 4, 1, 6, "NotoSansHebrew-Regular"},
    {26, 4, 1, 6, "NotoSansHebrew-Regular"},
    {28, 4, 1, 6, "NotoSansHebrew-Regular"},
    {48, 4, 1, 6, "NotoSansHebrew-Regular"},
    ...
    {14, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {18, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {24, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {20, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {23, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {26, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {28, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {30, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {38, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {48, 4, 1, 7, "NotoSansDevanagari-Regular"},
    {14, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {18, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {20, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {23, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {24, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {26, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {28, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {30, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {38, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {48, 4, 1, 8, "NotoSansMyanmar-Condensed"},
    {22, 4, 1, 9, "NotoSansBengali-Regular"},
    {26, 4, 1, 9, "NotoSansBengali-Regular"},
    {30, 4, 1, 9, "NotoSansBengali-Regular"},
    {34, 4, 1, 9, "NotoSansBengali-Regular"},
    {38, 4, 1, 9, "NotoSansBengali-Regular"},
    {48, 4, 1, 9, "NotoSansBengali-Regular"},
    {20, 4, 1, 9, "NotoSansBengali-Regular"},
    {23, 4, 1, 9, "NotoSansBengali-Regular"},
    {28, 4, 1, 9, "NotoSansBengali-Regular"},
...
static const LangTextParam g_langTextDefaultParamTable[LANGUAGE_MAX] = {
    ...
    {0, 30, "NotoSansMyanmar-Condensed", "my"},
