...
//@ts-ignore
import {PerfDataQuery, perfDataQuery} from "../../../../dist/trace/component/hiperf/PerfDataQuery.js"
...
describe('perfDataQuery Test',()=>{
    ...
    it('perfDataQueryTest10 ', function () {
        expect(perfDataQuery.searchData([],'')).toBeUndefined();
    });
    ...
    it('perfDataQueryTest12 ', function () {
        expect(perfDataQuery.initPrefData()).toBeUndefined();
    });

    it('perfDataQueryTest13 ', function () {
        expect(perfDataQuery.initCallChain([])).toBeUndefined();
    });
    ...
    it('perfDataQueryTest16 ', function () {
        expect(perfDataQuery.groupByCallChain([],true)).not.toBeUndefined();
    });
    ...
    it('perfDataQueryTest17 ', function () {
        ...
        expect(perfDataQuery.initCallChain(callChainsData)).toBeUndefined();
    });
    ...
    it('perfDataQueryTest20 ', function () {
        ...
        expect(perfDataQuery.groupByCallChain(callChainsData, true)).not.toBeUndefined();
    });
