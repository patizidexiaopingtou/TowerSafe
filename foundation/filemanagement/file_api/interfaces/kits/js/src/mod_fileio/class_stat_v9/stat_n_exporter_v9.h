...
#ifndef INTERFACES_KITS_JS_SRC_MOD_FILEIO_CLASS_STAT_N_EXPORTER_V9_H
#define INTERFACES_KITS_JS_SRC_MOD_FILEIO_CLASS_STAT_N_EXPORTER_V9_H
...
class StatNExporterV9 final : public NExporter {
public:
    inline static const std::string className_ = "StatV9";
...
#endif // INTERFACES_KITS_JS_SRC_MOD_FILEIO_CLASS_STATV9_N_EXPORTER_H