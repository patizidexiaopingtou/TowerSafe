...
#ifndef INTERFACES_KITS_JS_SRC_MOD_FILE_CLASS_FILE_FILE_N_EXPORTER_H
...
namespace {
    constexpr int32_t PARAMS_NUMBER_THREE = 3;
    constexpr int32_t DEFAULT_RESULT = -100;
}
enum COMMON_NUM {
    ZERO = 0,
    ONE = 1,
...
struct AsyncAccessCallbackInfo {
    ...
    napi_ref callback[PARAMS_NUMBER_THREE] = { 0 };
    std::string url = "";
    int errorType = -1;
...
#endif // INTERFACES_KITS_JS_SRC_MOD_FILE_CLASS_FILE_FILE_N_EXPORTER_H
