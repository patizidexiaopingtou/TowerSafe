...
#ifndef INTERFACES_KITS_JS_SRC_COMMON_NAPI_N_FUNC_ARG_H
#define INTERFACES_KITS_JS_SRC_COMMON_NAPI_N_FUNC_ARG_H
...
#endif // INTERFACES_KITS_JS_SRC_COMMON_NAPI_N_FUNC_ARG_H